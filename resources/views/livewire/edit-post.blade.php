<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="col-sm-10">
            <div class="form-floating mb-3">
                <input type="text" class="form-control" wire:model="category" value="{{$post->category}}" id="floatingInput" placeholder="category">
                <label for="floatingInput">Your category goes here..</label>
            </div>
            @error('content')
                <span class="text-danger">{{$message}}</span>
            @enderror
        ...
        <div class="col-sm-10">
            ...
            @enderror
                ...
                <a href="/posts/user" wire:navigate class="btn btn-secondary">cancel</a>
        </div>
    </form>
    </div>
</div>
